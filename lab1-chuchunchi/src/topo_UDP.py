...
if __name__ == '__main__':
   ...
   # iperf
    ...
    print("create flow h3toh2 via iperf")
    # UDP flow
    h3.cmd("iperf -s -i 1 -t 5 -p 7777 -b 10M -u > ../out/UDP_s_h3.txt &")
    h2.cmd("iperf -c " + "10.0.0.3" + " -i 1 -t 5 -p 7777 -b 10M -u > ../out/UDP_c_h2.txt &")

    # Create flow via iperf
    print("create flow h4toh1 via iperf")
    # UDP flow
    h4.cmd("iperf -s -i 1 -t 5 -p 7777 -b 8M -u > ../out/UDP_s_h4.txt &")
    h1.cmd("iperf -c " + "10.0.0.4" + " -i 1 -t 5 -p 7777 -b 8M -u > ../out/UDP_c_h1.txt &")
