...
class SimpleController(app_manager.RyuApp):
    ...
    def flow_removed_handler(self, ev):
        ...
        pktcount[paths-1] = msg.packet_count

        print("path: ", paths, " pktcount: ", pktcount[paths-1])
        ...
        if(True):
            ...
            print("choose path " , pktcount.index(max(pktcount))+1)



            if pktcount.index(max(pktcount))==0:
            ...
            if pktcount.index(max(pktcount))==1:
            ...
            if pktcount.index(max(pktcount))==2:
